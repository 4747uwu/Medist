...
const DoctorSearchBar = ({ onSearch, placeholder = "Search assigned patients..." }) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedFilter, setSelectedFilter] = useState('All');

  const handleSearch = (e) => {
    e.preventDefault();
    console.log('DoctorSearchBar - Submitting search:', searchTerm);
    onSearch(searchTerm);
  };

  const handleClear = () => {
    console.log('DoctorSearchBar - Clearing search');
    setSearchTerm('');
    onSearch('');
  };
